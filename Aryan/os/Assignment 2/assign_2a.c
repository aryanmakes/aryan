...
/*OUTPUT:
samarth@samarth-OptiPlex-7010:~/OS Lab/Assignment 2$ gcc assign_2a.c 
...
Exitind read
In Child Process
The elements sorted by Quicksort are
1	2	3	4	5	In Parent Process
The elements sorted by Bubblesort are
1	2	3	4	5	
