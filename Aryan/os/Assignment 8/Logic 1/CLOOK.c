...
/*OUTPUT:
samarth@samarth-OptiPlex-7010:~$ gcc CLOOK.c 
samarth@samarth-OptiPlex-7010:~$ ./a.out
Input the number of disk locations	7
...
Disk head moves from 199 to 190 with seek 9
Disk head moves from 190 to 170 with seek 20
Total seek time is 278
Average seek time is 39.714287
