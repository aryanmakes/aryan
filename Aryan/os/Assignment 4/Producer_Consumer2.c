...
/*OUTPUT:
samarth@samarth-OptiPlex-7010:~/OS Lab/Assignment 4$ gcc Producer_Consumer2.c 
samarth@samarth-OptiPlex-7010:~/OS Lab/Assignment 4$ ./a.out
...
************************************************************
0
samarth@samarth-OptiPlex-7010:~/OS Lab/Assignment 4$ 
*/
