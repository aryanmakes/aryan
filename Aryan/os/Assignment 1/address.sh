#Assignment 1 : B. Write a program to implement an address book with options given below: a) #Create address book. b) View address book. c) Insert a record. d) Delete a record. e) Modify a #record. f) Exit adress.sh 
