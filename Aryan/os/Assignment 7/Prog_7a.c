...
/*
OUTPUT :
samarth@samarth-OptiPlex-7010:~/OS Lab/Assignment 7$ gcc Prog_7a.c 
samarth@samarth-OptiPlex-7010:~/OS Lab/Assignment 7$ ./a.out
IN PARENT PROCESS

Enter name of file:abc.txt
Filename is being sent by Parent Process to Child Process through Pipe 1...

Filename 'abc.txt' is being read by Child Process through Pipe 1...

Contents of abc.txt are being sent to Parent Process through Pipe 2...

Contents of abc.txt are being received by Parent Process through Pipe 2...
...
I am shubham
student of AIML Engg.

samarth@samarth-OptiPlex-7010:~/OS Lab/Assignment 7$ 
*/
